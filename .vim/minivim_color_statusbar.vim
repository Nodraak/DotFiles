...
function! ChangeAccentColor()
  ...
  execute 'hi CursorLineNr ctermfg=241 ctermbg=237 guifg=' . accentColorGui
  execute 'hi LineNr ctermfg=' . accentColor . ' guifg=' . accentColorGui
  return ''
endfunction
function! ReadOnly()
...
"" Copied from sickill Monokai on Github, and slightly modified.
